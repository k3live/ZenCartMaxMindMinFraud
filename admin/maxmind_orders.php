...
// +----------------------------------------------------------------------+
//  $Id: maxmind_orders.php 1.4 2011-01-25 16:37:39Z ses707 $
//
...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
  <tr class="dataTableRow">
    <td width="25%" class="dataTableContent"><?php echo MAXMIND_IP_CITY . '<b>' . $maxmind_query->fields['ip_city'] . '</b>'; ?></td>
    <td width="25%" class="dataTableContent"><?php echo MAXMIND_IP_REGION . '<b>' . $maxmind_query->fields['ip_region'] . '</b>'; ?></td>
    <td width="25%" class="dataTableContent"><?php echo MAXMIND_IP_LATITUDE . '<b>' . $maxmind_query->fields['ip_latitude'] . '</b>'; ?></td>
    <td width="25%" class="dataTableContent"><?php echo MAXMIND_IP_LONGITUDE . '<b>' . $maxmind_query->fields['ip_longitude'] . '</b>'; ?></td>
  </tr>
</table>
<table width="100%" cellpadding="2" cellspacing="0" border="0">
  <tr class="dataTableHeadingRow">
...
//    $orders_query_numrows = '';
    ...
    if ((!isset($_GET['oID']) || (isset($_GET['oID']) && ($_GET['oID'] == $orders->fields['orders_id']))) && !isset($oInfo)) {
      ...
      if (isset($oInfo) && is_object($oInfo) && ($orders->fields['orders_id'] == $oInfo->orders_id)) {
        echo '              <tr id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . zen_href_link(FILENAME_MAXMIND_ORDERS, zen_get_all_get_params(array('oID', 'action')) . 'oID=' . $oInfo->orders_id . '&action=edit', 'NONSSL') . '\'">' . "\n";
      } else {
        echo '              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . zen_href_link(FILENAME_MAXMIND_ORDERS, zen_get_all_get_params(array('oID')) . 'oID=' . $orders->fields['orders_id'], 'NONSSL') . '\'">' . "\n";
      }
	  ...
	  $maxmind_quick_score = $db->Execute("select score from " . TABLE_ORDERS_MAXMIND . " where order_id = '" . $orders->fields['orders_id'] . "'");
	  $max_quick_img = round($maxmind_quick_score->fields['score']);
switch ($max_quick_img) {
case 0: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_green.gif', IMAGE_ICON_STATUS_GREEN, 10, 10); break;
case 1: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_green.gif', IMAGE_ICON_STATUS_GREEN, 10, 10); break;
case 2: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_green.gif', IMAGE_ICON_STATUS_GREEN, 10, 10); break;
case 3: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_green.gif', IMAGE_ICON_STATUS_GREEN, 10, 10); break;
case 4: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_yellow.gif', IMAGE_ICON_STATUS_YELLOW, 10, 10); break;
case 5: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_yellow.gif', IMAGE_ICON_STATUS_YELLOW, 10, 10); break;
case 6: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_yellow.gif', IMAGE_ICON_STATUS_YELLOW, 10, 10); break;
case 7: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_red.gif', IMAGE_ICON_STATUS_RED, 10, 10); break;
case 8: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_red.gif', IMAGE_ICON_STATUS_RED, 10, 10); break;
case 9: $max_quick_img = $maxmind_quick_score->fields['score'] . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_red.gif', IMAGE_ICON_STATUS_RED, 10, 10); break;
...
<?php
  ...
  switch ($action) {
    case 'delete':
      ...
      $contents = array('form' => zen_draw_form('orders', FILENAME_MAXMIND_ORDERS, zen_get_all_get_params(array('oID', 'action')) . 'oID=' . $oInfo->orders_id . '&action=deleteconfirm', 'post', '', true));
//      $contents[] = array('text' => TEXT_INFO_DELETE_INTRO . '<br /><br /><strong>' . $cInfo->customers_firstname . ' ' . $cInfo->customers_lastname . '</strong>');
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . zen_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a href="' . zen_href_link(FILENAME_MAXMIND_ORDERS, zen_get_all_get_params(array('oID', 'action')) . 'oID=' . $oInfo->orders_id, 'NONSSL') . '">' . zen_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>');
      break;
    default:
...
// indicate if comments exist
      ...
      if (sizeof($order->products) > 0) {
        $contents[] = array('align' => 'center', 'text' => '<a href="' . zen_href_link(FILENAME_MAXMIND_ORDERS, zen_get_all_get_params(array('oID', 'action')) . 'oID=' . $oInfo->orders_id . '&action=edit', 'NONSSL') . '">' . zen_image_button('button_edit.gif', IMAGE_EDIT) . '</a>');
      }
      break;
  }
